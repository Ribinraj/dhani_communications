      ...
      body:
          ...
          >(
            listener: (context, state) {
              if (state is UpdateApprovelAttendenceLoadingState) {
                showDialog(
                  context: context,
              ...
              } else if (state is UpdateApprovelAttendenceSuccessState) {
                ...
                context.pop();
              } else if (state is UpdateApprovelAttendenceErrorState) {
                Navigator.of(context, rootNavigator: true).pop();
                CustomSnackbar.show(
                  context: context,
                  message: state.message,
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              TextStyles.body(
                text: context.tr(
                  'are_you_sure_you_want_to_approve_this_attendance',
                ),
                color: Appcolors.kgreyColor,
              ),
              ResponsiveSizedBox.height30,
