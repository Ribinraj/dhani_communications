...
class ScreenLeaveApprovelDetailpage extends StatelessWidget {
  ...
  const ScreenLeaveApprovelDetailpage({super.key, required this.leave});
  ...
  Widget build(BuildContext context) {
    final String status = _getStatusDisplay(leave.status);
    final bool isPending = _isPending(leave.status);
    final leaveTypeColor = _leaveColor(leave.leaveCategoryName);
    ...
    return BlocListener<UpdateApprovelLeaveBloc, UpdateApprovelLeaveState>(
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Icon(
                            _leaveIcon(leave.leaveCategoryName),
                            color: Appcolors.kwhitecolor,
                            size: ResponsiveUtils.sp(4.5),
                          ),
                          ResponsiveSizedBox.width(1.5),
                          TextStyles.medium(
                            text: leave.leaveCategoryName,
                            weight: FontWeight.w600,
                            color: Appcolors.kwhitecolor,
                          ),
                        ],
              ...
              _buildSectionCard(
                ...
                children: [
                  ...
                  _buildDetailRow(
                    ...
                    iconColor: Colors.indigo,
                    label: 'Created',
                    value: _formatDate(leave.createdDate),
                  ),
                  ResponsiveSizedBox.height20,
                  // Last Modified
                  _buildDetailRow(
                    ...
                    label: 'Last Modified',
                    value: _formatDate(leave.lastModifiedDate),
                  ),
                ],
              ),
              ResponsiveSizedBox.height(3),
                ...
                _buildSectionCard(
                  ...
                  children: [
                    ...
                    _buildDetailRow(
                      ...
                      iconColor: Appcolors.kprimarycolor,
                      label: 'Longitude',
                      value: leave.leavesLong,
                    ),
                    if (leave.distanceFromHQ.isNotEmpty) ...[
                      ResponsiveSizedBox.height20,
                      _buildDetailRow(
                        icon: Icons.location_on_rounded,
                        iconColor: Colors.red,
                        label: 'Distance from HQ',
                        value: '${leave.distanceFromHQ} m',
                      ),
                    ],
                  ],
                ),
              ...
              // ─── HQ Remarks ───
              if (leave.headquarterRemarks != null &&
                ...
                _buildRemarksCard(
                  ...
                  remarks: leave.headquarterRemarks,
                  emptyText: '',
                ),
              ],

              // ─── Documents ───
              if (leave.leaveDocuments.isNotEmpty) ...[
                ResponsiveSizedBox.height(3),
                Container(
                  width: double.infinity,
                  padding: EdgeInsets.all(ResponsiveUtils.wp(4)),
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: TextStyles.caption(
                              text: '${leave.leaveDocuments.length} files',
                              weight: FontWeight.w600,
                              color: Appcolors.kprimarycolor,
                            ),
                          ),
                      ...
                      ResponsiveSizedBox.height15,
                      ...List.generate(leave.leaveDocuments.length, (index) {
                        final document = leave.leaveDocuments[index];
                        return _buildDocumentItem(
                          context,
                          document,
                          index,
                          leave.leaveDocuments.length,
                        );
                      }),
                    ],
                  ),
