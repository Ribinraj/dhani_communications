...
class _ScreenApproveEmployeesAttendancePageState
  ...
  // void _showApproveDialog(Map<String, dynamic> attendance, int index) {
  //   showDialog(
  //     context: context,
  ...
  //               TextStyles.medium(
  //                 text:
  //                     'Are you sure you want to approve attendance for ${attendance['employeeName']}?',
  ...
  //                       onPressed: () {
  //                         setState(() {
  //                           attendanceList[index]['approved'] = true;
  //                         });
  //                         Navigator.pop(context);
  ...
  // void _showRejectDialog(Map<String, dynamic> attendance, int index) {
  //   showDialog(
  //     context: context,
  //     builder: (BuildContext context) {
  //       return Dialog(
  ...
  //               TextStyles.medium(
  //                 text:
  //                     'Are you sure you want to reject attendance for ${attendance['employeeName']}?',
  //                 color: Appcolors.kgreyColor,
  //                 textAlign: TextAlign.center,
  //               ),
  //               ResponsiveSizedBox.height30,
  ...
  //                       onPressed: () {
  //                         setState(() {
  //                           attendanceList[index]['approved'] = false;
  //                         });
  //                         Navigator.pop(context);
  //                         ScaffoldMessenger.of(context).showSnackBar(
  //                           SnackBar(
